...
router.post('/get-weekly-working-hours-drivers', trainTripController.getWeeklyWorkingHoursDrivers);
router.post('/get-total-truck-usage-hours', trainTripController.getTotalTruckUsageHoursThisWeek);
router.get('/get-sales-by-cities-and-routes', trainTripController.getSalesByCitiesAndRoutes);
router.get('/get-items-with-most-orders', trainTripController.getItemsWithMostOrdersCurrentYear);
router.get('/get-quarterly-sales-report', trainTripController.getQuarterlySalesReport);
